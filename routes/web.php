...
Route::delete('/mensalidades/{mensalidade}/cancela', 'MensalidadesController@cancela')->name('mensalidades.cancela');
Route::put('/mensalidades/{mensalidade}/reativa', 'MensalidadesController@reativa')->name('mensalidades.reativa');
Route::get('/mensalidades/{mensalidade}/baixa', 'MensalidadesController@baixa')->name('mensalidades.baixa');
Route::put('/mensalidades/{mensalidade}/baixa/store', 'MensalidadesController@storeBaixa')->name('mensalidades.baixa.store');
Route::delete('/mensalidades/{mensalidade}/baixa/estorna', 'MensalidadesController@estornaBaixa')->name('mensalidades.baixa.estorna');
